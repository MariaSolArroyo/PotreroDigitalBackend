...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Precio mayor a 500</title>
    <!-- CSS only -->
...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.9.1/font/bootstrap-icons.css">
  ...
  <body>
      ...
      <section class="ropa">
        ...
        <button class="botoninicio" type="submit" name="buzos"> <a class="enlacebotones" href="buzos.php">Buzos</a> </button>
        <button class="botoninicio" type="submit" name="nike"> <a class="enlacebotones" href="nike.php">Productos Nike</a> </button>
        <button class="botoninicio botonpreciomayor" type="submit" name="preciomayor"> <a class="enlacebotones" href="preciomayor.php">Precios Mayor a 500</a> </button>
      </section>
      <section class="textoytabla">
          <h6>Productos de costo mayor a 500</h6>
